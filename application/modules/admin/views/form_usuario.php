				...
				<div class="x_content">
					...
					<form id="form" data-parsley-validate class="form-horizontal form-label-left">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="hora_contrato" name="hora_contrato" class="form-control col-md-7 col-xs-12 has-feedback-left" value="<?php echo $information?$information[0]["hora_contrato"]:""; ?>" maxlength=5 placeholder="Hour contract value">
								<span class="fa fa-dollar form-control-feedback left" aria-hidden="true"></span>
							</div>
						</div>
